...
#body wei
WEIGHT_SPEC = {WEIGHT_UNIT_KILOGRAMS_SLUG: RANGE_SPEC_BY_UNIT[BODY_TEMP_SLUG][WEIGHT_UNIT_KILOGRAMS_SLUG],
               WEIGHT_UNIT_POUNDS_SLUG: RANGE_SPEC_BY_UNIT[BODY_TEMP_SLUG][WEIGHT_UNIT_POUNDS_SLUG],
               WEIGHT_UNIT_STONES_SLUG: RANGE_SPEC_BY_UNIT[BODY_TEMP_SLUG][WEIGHT_UNIT_STONES_SLUG]}
